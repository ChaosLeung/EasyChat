...
public class FriendDao extends AbstractDao<Friend, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property FriendPeerId = new Property(2, String.class, "friendPeerId", false, "FRIEND_PEER_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'FRIEND' (" + //
                ...
                "'FRIEND_PEER_ID' TEXT);"); // 2: friendPeerId
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Friend entity) {
        ...
        String friendPeerId = entity.getFriendPeerId();
        if (friendPeerId != null) {
            stmt.bindString(3, friendPeerId);
        }
    }
    ...
    public Friend readEntity(Cursor cursor, int offset) {
        Friend entity = new Friend( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2) // friendPeerId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Friend entity, int offset) {
        ...
        entity.setFriendPeerId(cursor.isNull(offset + 2) ? null : cursor.getString(offset + 2));
     }
